unsigned int __cdecl sub_6F6ADDE0(_WORD *a1, unsigned int *a2, int a3, int a4, int a5, int a6, int a7, int a8, int a9)
{
  ...
  if ( BYTE3(result) & 0x40 )
  {
    ...
    if ( (unsigned int)BYTE3(result) >> 7 )
    {
      ...
      *a1 = (4 * ((*((_WORD *)v13 + 2) + v16 - 255) & ((v13[1] + v16 - 255) >> 31)) + 1020) & 0x3E0 | ((((unsigned __int16)(*((_WORD *)v13 + 4) + v17 - 255) & (unsigned __int16)((v13[2] + v17 - 255) >> 31)) + 255) << 7) & 0x7C00 | ((((v11 + dword_6FBBFE50[v12] - 255) & ((v11 + dword_6FBBFE50[v12] - 255) >> 31)) + 255) >> 3) & 0x1F | 0x8000;
      ...
      result = (((v15 >> 31) & v15) + 255) | (((((v16 + BYTE1(v14) - 255) >> 31) & (v16 + BYTE1(v14) - 255)) + 255) << 8) | ((((v17 + (unsigned __int8)(*a2 >> 16) - 255) & ((v17 + (unsigned __int8)(*a2 >> 16) - 255) >> 31)) + 255) << 16);
      *a2 = result | ((unsigned __int8)v10 << 24);
    }
    else
    {
