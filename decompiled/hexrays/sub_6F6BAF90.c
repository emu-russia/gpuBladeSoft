int __cdecl sub_6F6BAF90(_WORD *a1, unsigned int *a2, int a3, int a4, unsigned __int8 a5, unsigned __int8 a6, unsigned __int8 a7)
{
  int result; // eax@1
  signed int v8; // ecx@2
  signed int v9; // esi@2
  ...
  if ( (signed __int16)result >= 0 )
  {
    ...
    *a2 = ((((v12 >> 17) & 0x7F) + v10) << 16) | ((v13 + v9) << 8) | (result + v8);
  }
  return result;
}
