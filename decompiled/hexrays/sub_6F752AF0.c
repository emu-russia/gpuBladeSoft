signed int __usercall sub_6F752AF0@<eax>(unsigned int a1@<eax>, unsigned int a2@<edx>, int a3@<ecx>, int a4)
{
  size_t v4; // ebx@2
  _BYTE *v5; // edi@2
  _BYTE *v6; // eax@3
...
LABEL_69:
  ...
  if ( sub_6F807530(dword_70259108, (int)&v90) )
  {
    nullsub_10();
    result = 1;
  }
  else if ( sub_6F807B10(dword_70259108, a4, (int)&v89) )
  {
    sub_6F82FF10((int)&unk_70258FA0, (int)&v89);
    while ( sub_6F830C00((int)&unk_70258FA0, (int)&v85) )
    {
      fwrite(v85, v86, 1u, (FILE *)dword_70258F80);
      fwrite(v87, v88, 1u, (FILE *)dword_70258F80);
    }
    free(v73);
    free(v83);
    free(v84);
