void __cdecl sub_6F6D5080(_WORD *a1, _DWORD *a2, int a3, int a4, unsigned __int8 a5, unsigned __int8 a6, unsigned __int8 a7, int a8, int a9)
{
  ...
  if ( *a1 >= 0 )
  {
    ...
    if ( BYTE3(v9) & 0x40 )
    {
      ...
      else
      {
        ...
        dword_6FCFFE50(a3, a4, &v19);
        v16 = (4 * ((((v20 & ~(v20 >> 31)) - 255) >> 31) & ((v20 & ~(v20 >> 31)) - 255)) + 1020) & 0x3E0 | (((((v19 & ~(v19 >> 31)) - 255) & (((v19 & ~(v19 >> 31)) - 255) >> 31)) + 255) >> 3) & 0x1F | ((((unsigned __int16)((v21 & ~(v21 >> 31)) - 255) & (unsigned __int16)(((v21 & ~(v21 >> 31)) - 255) >> 31)) + 255) << 7) & 0x7C00;
        *a1 = v16;
        v15 = v16;
      }
