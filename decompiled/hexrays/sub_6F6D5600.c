void __cdecl sub_6F6D5600(_WORD *a1, _DWORD *a2, int a3, int a4, unsigned __int8 a5, unsigned __int8 a6, unsigned __int8 a7, int a8, int a9)
{
  ...
  if ( *a1 >= 0 )
  {
    ...
    if ( BYTE3(v9) & 0x40 )
    {
      ...
      if ( v10 >> 7 )
      {
        ...
        v15 = 16 * *a1;
        v16 = ((((((v22 & ~(v22 >> 31)) - 255) >> 31) & ((v22 & ~(v22 >> 31)) - 255)) + 255) >> 1)
            + (*(int *)((char *)dword_6FBBFE50 + v15) >> 1)
            - 255;
        v17 = ((signed int)((((signed int)((v23 & ~((unsigned __int64)v23 >> 32)) - 255) >> 31) & ((v23 & ~((unsigned __int64)v23 >> 32))
                                                                                                 - 255))
                          + 255) >> 1)
            + (*(int *)((char *)&dword_6FBBFE50[1] + v15) >> 1)
            - 255;
        LOWORD(v15) = (4 * ((v17 >> 31) & v17) + 1020) & 0x3E0 | ((((unsigned __int16)(((((((v24 & ~(v24 >> 31)) - 255) >> 31) & ((v24 & ~(v24 >> 31)) - 255))
                                                                                       + 255) >> 1)
                                                                                     + (*(int *)((char *)&dword_6FBBFE50[2]
                                                                                               + v15) >> 1)
                                                                                     - 255) & (unsigned __int16)((((((((v24 & ~(v24 >> 31)) - 255) >> 31) & ((v24 & ~(v24 >> 31)) - 255)) + 255) >> 1) + (*(int *)((char *)&dword_6FBBFE50[2] + v15) >> 1) - 255) >> 31))
