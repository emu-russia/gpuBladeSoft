int *__thiscall sub_6F8BFE70(void *this, int a2, int a3, int a4, int a5, int *a6)
{
  int v6; // edx@1
  _DWORD *v7; // eax@1
  ...
  LOBYTE(v9) = 0;
  v18 = 1;
  sub_6F911B90(v9, v7, (int)&v25, a3, a4, a5, v14, v6);
  if ( !v27 )
    sub_6F95AFD0("uninitialized __any_string");
  v18 = 1;
  sub_6F909D80(v16, v25, v26, (int)&v24);
  if ( v27 )
  {
    v18 = 0;
    v27(&v25);
