unsigned int __fastcall sub_6F8ED7F0(unsigned int a1, int a2, unsigned int a3, unsigned int a4, int a5, int a6, int a7, _DWORD *a8, int a9)
{
  __int64 v9; // rax@1
  ...
  v42 = sub_6F937FA0();
  v25 = &v42;
  sub_6F959D50((int)v41, (float *)a9, a8);
