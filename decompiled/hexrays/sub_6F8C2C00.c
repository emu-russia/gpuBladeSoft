signed int __thiscall sub_6F8C2C00(int this, int a2, int a3, int a4, _DWORD *a5, int a6, int a7, int *a8)
{
  ...
  v16 = a6;
  v17 = a7;
  if ( *(_BYTE *)(this + 12) & 2 && !(unsigned __int8)sub_6F90DA30((int)&v16) )
  {
LABEL_14:
    result = 1;
    goto LABEL_15;
...
LABEL_16:
  ...
  {
    v13 = *(_DWORD *)v9;
    if ( (unsigned int)(*(_DWORD *)v9 - 55296) <= 0x3FF )
      break;
    if ( v13 - 56320 <= 0x3FF )
      goto LABEL_13;
    v12 = 1;
