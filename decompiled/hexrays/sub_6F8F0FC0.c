int __stdcall sub_6F8F0FC0(int a1, int a2, int a3, int a4, int a5, _DWORD *a6, int a7)
{
  int v7; // eax@1
  int v8; // ebx@1
  __int64 v9; // rax@1
  ...
  v9 = sub_6F8F1BD0(__PAIR__(a2, a1), a3, a4, a5, a6, a7, (const char *)*(_DWORD *)(*(_DWORD *)(v7 + 8) + 16));
  v8 = v9;
