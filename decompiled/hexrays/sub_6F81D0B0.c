int __usercall sub_6F81D0B0@<eax>(int a1@<eax>, int a2@<edx>, unsigned int a3@<ecx>, int a4, int a5, int a6, int a7)
{
  int v7; // ebx@1
  int v8; // esi@1
  ...
  v67 = *(_DWORD *)(a1 + 496);
  v65 = *(_DWORD *)(a1 + 208);
  v8 = *(_DWORD *)(v7 + 4 * *(_DWORD *)(v7 + 276) + 480);
  ...
  *(_DWORD *)(a2 + 8) = 0;
  ...
  v31 = (unsigned __int8)*(&byte_6FB88B90[*(_BYTE *)(*(_DWORD *)(v30 + 51632) + 2)] + (((_WORD)v28 + 1) & 0x1F8));
  v32 = *(_DWORD *)(v7 + 4 * v29 + 51720);
  v33 = (unsigned __int8)*(&byte_6FB88B90[*(_BYTE *)(*(_DWORD *)(v30 + 51632) + 2)] + (((_WORD)v28 + 1) & 0x1F8));
  if ( *(_DWORD *)(v7 + 4 * v29 + 51720) - v66 <= 6 )
  {
    ...
    while ( v29 )
    {
      v35 = (unsigned __int8)*(&byte_6FB88B90[*(_BYTE *)(*(_DWORD *)(v7 + 4 * v29 + 51632) + 2)]
                             + (((_WORD)v29 + 1) & 0x1F8))
          + v32;
LABEL_12:
      if ( v64 <= v35 )
