unsigned int __cdecl sub_6F6ADDA0(_WORD *a1, unsigned int *a2, int a3, int a4, int a5, int a6, int a7, int a8, int a9)
{
  ...
  if ( BYTE3(result) & 0x40 )
  {
    ...
    if ( (unsigned int)BYTE3(result) >> 7 )
    {
      ...
      *a1 = 4 * ((*((_WORD *)v13 + 2) - v16) & ~(unsigned __int16)((v13[1] - v16) >> 31)) & 0x3E0 | (((unsigned __int16)(*((_WORD *)v13 + 4) - v15) & (unsigned __int16)~(unsigned __int16)((v13[2] - v15) >> 31)) << 7) & 0x7C00 | ((signed int)((dword_6FBBFE50[v12] - v11) & ~((unsigned __int64)(dword_6FBBFE50[v12] - v11) >> 32)) >> 3) & 0x1F | 0x8000;
      v14 = *a2;
      result = ~(((unsigned __int8)*a2 - v11) >> 31) & ((unsigned __int8)*a2 - v11) | ((~((BYTE1(v14) - v16) >> 31) & (BYTE1(v14) - v16)) << 8) | ((((unsigned __int8)(*a2 >> 16) - v15) & ~(((unsigned __int8)(*a2 >> 16) - v15) >> 31)) << 16);
      *a2 = result | (v10 << 24);
    }
    else
    {
