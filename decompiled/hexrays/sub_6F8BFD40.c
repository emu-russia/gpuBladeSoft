_DWORD *__thiscall sub_6F8BFD40(_DWORD *this, int a2, int a3, int a4, int a5, int a6)
{
  _DWORD *v6; // eax@1
  int v7; // ebx@2
  _BYTE *v8; // edx@2
  ...
  _BYTE *v16; // [sp+18h] [bp-70h]@1
  int v17; // [sp+1Ch] [bp-6Ch]@1
  _DWORD *v18; // [sp+28h] [bp-60h]@1
  ...
  _BYTE *v26; // [sp+64h] [bp-24h]@1
  int v27; // [sp+68h] [bp-20h]@2
  void (__cdecl *v28)(_DWORD); // [sp+7Ch] [bp-Ch]@1
  ...
  LOBYTE(v11) = 0;
  v20 = 1;
  sub_6F911A10(v11, v6, (int)&v26, a3, a4, a5, v16, v17);
  if ( !v28 )
