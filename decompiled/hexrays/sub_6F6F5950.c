int __cdecl sub_6F6F5950(_WORD *a1, _DWORD *a2, int a3, int a4, unsigned __int8 a5, unsigned __int8 a6, unsigned __int8 a7)
{
  __int64 v7; // rax@1
  int v8; // edi@1
  signed int v9; // ecx@1
  ...
  result = v11 | HIDWORD(v7) | ((((v9 >> 31) & v9) + 255) >> 3) & 0x1F;
  *a1 = result;
