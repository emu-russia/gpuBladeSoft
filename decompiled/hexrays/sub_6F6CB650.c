int __cdecl sub_6F6CB650(_WORD *a1, int *a2, int a3, int a4, unsigned __int8 a5, unsigned __int8 a6, unsigned __int8 a7)
{
  int v7; // edi@1
  int *v8; // esi@1
  signed int v9; // ebp@1
  ...
  *a2 = ~(((unsigned __int8)*a2 - a5) >> 31) & ((unsigned __int8)*a2 - a5) | ((~(((unsigned __int8)((unsigned int)*a2 >> 16)
                                                                                - a7) >> 31) & ((unsigned __int8)((unsigned int)*a2 >> 16)
                                                                                              - a7)) << 16) | (((BYTE1(v12) - a6) & ~((BYTE1(v12) - a6) >> 31)) << 8);
