unsigned int __cdecl sub_6F6C34C0(_WORD *a1, unsigned int *a2, int a3, int a4, int a5, int a6, int a7, int a8, int a9)
{
  ...
  if ( BYTE3(result) & 0x40 )
  {
    ...
    if ( (unsigned int)BYTE3(result) >> 7 )
    {
      ...
      *a1 = (4 * (v16 & (v16 >> 31)) + 1020) & 0x3E0 | ((((unsigned __int16)v15 & (unsigned __int16)(v15 >> 31)) + 255) << 7) & 0x7C00 | (((((unsigned __int8)result + dword_6FBBFE50[v14] - 255) & (((unsigned __int8)result + dword_6FBBFE50[v14] - 255) >> 31)) + 255) >> 3) & 0x1F | 0x8000;
      ...
      v19 = v13 + (unsigned __int8)(*a2 >> 16) - 255;
      v20 = ((((v12 + BYTE1(v17) - 255) >> 31) & (v12 + BYTE1(v17) - 255)) + 255) << 8;
      result = v18 >> 31;
      *a2 = (((v18 >> 31) & v18) + 255) | v20 | (((v19 & (v19 >> 31)) + 255) << 16) | (v10 << 24);
    }
    else
    {
