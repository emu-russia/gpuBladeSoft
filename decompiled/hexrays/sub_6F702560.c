unsigned int __cdecl sub_6F702560(_WORD *a1, int a2, int a3, int a4, unsigned __int8 a5, unsigned __int8 a6, unsigned __int8 a7, int a8, int a9)
{
  ...
  if ( *a1 >= 0 )
  {
    ...
    if ( (result >> 24) & 0x40 )
    {
      ...
      v13 = ((((v16 & ~(v16 >> 31)) - 255) & (((v16 & ~(v16 >> 31)) - 255) >> 31)) + 255) << 7;
      LOWORD(v13) = v13 & 0x7C00;
      result = v13 | v12 | (((((v14 & ~(v14 >> 31)) - 255) & (((v14 & ~(v14 >> 31)) - 255) >> 31)) + 255) >> 3) & 0x1F;
