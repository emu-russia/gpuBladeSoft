unsigned int __usercall sub_6F691580@<eax>(unsigned int result@<eax>, int *a2@<edx>, unsigned __int8 a3@<cl>, unsigned __int8 a4, unsigned __int8 a5, int a6, int a7)
{
  _WORD *v7; // edi@2
