__int64 __thiscall sub_6F8C1660(void *this, int a2, int a3, int a4, int a5, int a6, int a7)
{
  _BYTE *v7; // eax@1
  int v8; // edx@1
  int v9; // eax@1
  int v11; // [sp+0h] [bp-A8h]@1
  ...
  v8 = *(_DWORD *)(a7 + 4);
  v23 = 1;
  sub_6F93A6C0((int)&v29, v7, &v7[v8], v12);
  v31 = sub_6F911930;
  v18 = (int *)&v29;
  *(double *)&v17 = 0.0;
  v16 = (char)v19;
  ...
  v9 = *(_DWORD *)(v20 + 8);
  LOBYTE(v11) = 0;
  v20 = sub_6F910150(v11, v9, a2, a3, (unsigned __int8)v21, a5, (char)v19, v17, (int)&v29);
  if ( v31 )
  {
    v23 = 0;
    v31((void **)&v29);
