int __cdecl sub_6F6FF320(_WORD *a1, int a2, int a3, int a4, unsigned __int8 a5, unsigned __int8 a6, unsigned __int8 a7)
{
  int result; // eax@1
  int v8; // eax@2
  signed int v9; // ebp@2
  ...
  if ( (signed __int16)result >= 0 )
  {
    ...
    result = v12 | ((((signed int)a5 >> 1) + (v9 >> 1)) >> 3) & 0x1F | v11;
    *a1 = result;
  }
  return result;
}
