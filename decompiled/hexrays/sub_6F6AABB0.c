unsigned int __cdecl sub_6F6AABB0(_WORD *a1, int *a2, int a3, int a4, unsigned __int8 a5, unsigned __int8 a6, unsigned __int8 a7, int a8, int a9)
{
  ...
  int v18; // eax@3
  int v19; // edx@3
  int v20; // [sp+20h] [bp-2Ch]@3
  int v21; // [sp+24h] [bp-28h]@3
  int v22; // [sp+28h] [bp-24h]@3
