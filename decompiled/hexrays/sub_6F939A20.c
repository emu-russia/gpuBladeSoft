int __thiscall sub_6F939A20(int this, int a2, int a3)
{
  void *v3; // eax@1
  char *v4; // esi@3
  int result; // eax@3
  ...
  *(_DWORD *)(*(_DWORD *)(this + 8) + 8) = &unk_6FBA6090;
  *(_DWORD *)(*(_DWORD *)(this + 8) + 12) = 0;
  *(_DWORD *)(*(_DWORD *)(this + 8) + 24) = &unk_6FBA6092;
  *(_DWORD *)(*(_DWORD *)(this + 8) + 28) = 0;
  *(_DWORD *)(*(_DWORD *)(this + 8) + 32) = &unk_6FBA6092;
  *(_DWORD *)(*(_DWORD *)(this + 8) + 36) = 0;
  *(_DWORD *)(*(_DWORD *)(this + 8) + 40) = &unk_6FBA6092;
