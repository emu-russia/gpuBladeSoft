int __cdecl sub_6F6B7A80(_WORD *a1, int *a2, int a3, int a4, unsigned __int8 a5, unsigned __int8 a6, int a7)
{
  int result; // eax@1
  int v8; // ecx@2
  int v9; // edx@2
  ...
  if ( *a1 >= 0 )
  {
    ...
    LOWORD(v8) = v8 & 0x3E0;
    v9 = (((((v12 & ~(v12 >> 31)) - 255) >> 31) & ((v12 & ~(v12 >> 31)) - 255)) + 255) << 7;
    LOWORD(v9) = v9 & 0x7C00;
    result = v9 | v8 | (((((v10 & ~(v10 >> 31)) - 255) & (((v10 & ~(v10 >> 31)) - 255) >> 31)) + 255) >> 3) & 0x1F;
    *a1 = result;
    *a2 = (a6 << 8) | a5 | ((unsigned __int8)a7 << 16);
  }
  return result;
}
