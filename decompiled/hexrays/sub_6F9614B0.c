int __thiscall sub_6F9614B0(char *this)
{
  char *v1; // ebx@1
  int v2; // ebx@1
  ...
  *(_DWORD *)v2 = off_6FBB05AC;
  *(_DWORD *)(v2 + 112) = off_6FBB05C0;
  *(_DWORD *)(v2 + 4) = off_6FBB03D8;
  v5 = 0;
  sub_6F917A70((void *)(v2 + 4));
  sub_6F90E8A0(v2 + 40);
  *(_DWORD *)(v2 + 4) = off_6FBB06B4;
  sub_6F938380((volatile signed __int32 **)(v2 + 32));
  *(_DWORD *)v2 = &unk_6FBABE90;
  *(_DWORD *)(v2 + 112) = off_6FBB0FD0;
