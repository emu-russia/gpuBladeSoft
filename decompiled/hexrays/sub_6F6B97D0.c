int __cdecl sub_6F6B97D0(_WORD *a1, int *a2, int a3, int a4, unsigned __int8 a5, unsigned __int8 a6, unsigned __int8 a7, int a8, int a9)
{
  int result; // eax@1
  ...
  if ( *a1 >= 0 )
  {
    ...
    if ( result & 0x40 )
    {
      ...
      {
        v27 = ((v15 >> 31) & v15) + 255;
        v28 = ((((a6 * v13 >> 7) - 255) >> 31) & ((a6 * v13 >> 7) - 255)) + 255;
