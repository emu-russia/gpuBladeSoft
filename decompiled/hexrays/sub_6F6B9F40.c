_WORD *__cdecl sub_6F6B9F40(_WORD *a1, int *a2, int a3, int a4, unsigned __int8 a5, unsigned __int8 a6, unsigned __int8 a7)
{
  _WORD *result; // eax@1
  int v8; // edi@1
  int v9; // edi@2
  ...
  if ( (signed __int16)v8 >= 0 )
  {
    ...
    *a1 = ((((unsigned __int16)((v12 + dword_6FBBFE50[v9 + 2] - 255) >> 31) & (unsigned __int16)(v12
    ...
    v16 = ((v11 + BYTE1(v13) - 255) >> 31) & (v11 + BYTE1(v13) - 255);
    result = a1;
    *a2 = (((v14 >> 31) & v14) + 255) | (((v15 & (v15 >> 31)) + 255) << 16) | ((v16 + 255) << 8);
