_WORD *__usercall sub_6F690F40@<eax>(_WORD *result@<eax>, unsigned int *a2@<edx>, unsigned __int8 a3@<cl>, unsigned __int8 a4, unsigned __int8 a5)
{
  int v5; // ebx@1
  int v6; // ebx@2
  signed int v7; // esi@2
  ...
  if ( (signed __int16)v5 >= 0 )
  {
    ...
    *result = ((((unsigned __int16)(v7 >> 31) & (unsigned __int16)v7) + 255) << 7) & 0x7C00 | (4
    ...
    result = (_WORD *)((((v9 >> 31) & v9) + 255) | (((((a4 + BYTE1(v8) - 255) >> 31) & (a4 + BYTE1(v8) - 255)) + 255) << 8) | ((((a5 + (unsigned __int8)(*a2 >> 16) - 255) & ((a5 + (unsigned __int8)(*a2 >> 16) - 255) >> 31)) + 255) << 16));
