__int64 __thiscall sub_6F8C1790(void *this, int a2, int a3, int a4, int a5, int a6, _DWORD *a7)
{
  int v7; // eax@1
  int v8; // eax@1
  ...
  *(double *)&v16 = 0.0;
  ...
  v8 = *(_DWORD *)(v19 + 8);
  LOBYTE(v10) = 0;
  v19 = sub_6F9102F0(v10, v8, a2, a3, (unsigned __int8)v20, a5, (char)v18, v16, (int)&v28);
  if ( v30 )
  {
    v22 = 0;
    v30((int *)&v28);
