__int64 __cdecl sub_6F910620(int a1, int a2, int a3, int a4, int a5, int a6, int a7, _TBYTE a8, int a9)
{
  int v9; // edx@3
  ...
  if ( a9 )
  {
    ...
    LOBYTE(v20) = 0;
    v27 = -1;
    sub_6F93D440((void **)&v33, v10, (int)v10 + 2 * v9, v20);
    v11 = *(_DWORD *)a2;
    LODWORD(v23) = &v33;
    ...
    v27 = 1;
    LODWORD(v13) = v12(a2, a3, a4, (unsigned __int8)v24, a6, (unsigned __int16)v25, &v33);
    v24 = v13;
    if ( v33 != &v34 )
      j_free_1(v33);
  }
