int __cdecl sub_6F70B010(_WORD *a1, int a2, int a3, int a4, unsigned __int8 a5, unsigned __int8 a6, unsigned __int8 a7)
{
  int v7; // ebx@1
  int v8; // ebx@2
  signed int v9; // esi@2
  ...
  if ( (signed __int16)v7 >= 0 )
  {
    ...
    v14 = v13 | v12 | ((((v9 >> 31) & v9) + 255) >> 3) & 0x1F;
    *a1 = v14;
    result = (((HIBYTE(word_6FBB979C) >> 3) & 1) << 15) | v14;
    *a1 = result;
  }
  return result;
}
