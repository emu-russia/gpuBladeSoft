__int64 __stdcall sub_6F8D4230(__int64 a1, int a2, __int16 a3, int a4, _DWORD *a5, int a6)
{
  int v6; // eax@3
  int v7; // eax@7
  char *v8; // eax@7
  ...
  v108 = sub_6F8C3BF0(&unk_6FB49F6C);
