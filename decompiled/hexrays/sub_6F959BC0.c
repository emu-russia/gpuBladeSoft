int __cdecl sub_6F959BC0(const char *a1, double *a2, _DWORD *a3)
{
  const char *v3; // eax@1
  size_t v4; // eax@1
  double v5; // st7@1
  ...
  const char *v20; // [sp+5Ch] [bp-10h]@1
  ...
  *a2 = v5;
  ...
  else if ( v5 < -1.189731495357231765e4932 || v5 > 1.189731495357231765e4932 )
  {
    if ( v5 <= 0.0 )
      v7 = -1.189731495357231765e4932;
    else
      v7 = 1.189731495357231765e4932;
    *a2 = v7;
    *a3 = 4;
