__int64 __cdecl sub_6F910480(int a1, int a2, int a3, int a4, int a5, int a6, int a7, _TBYTE a8, int a9)
{
  int v9; // eax@3
  ...
  __int64 v16; // rax@6
  const void *v17; // [sp+18h] [bp-78h]@1
  ...
  if ( a9 )
  {
    ...
    v17 = *(const void **)a9;
    v26 = -1;
    sub_6F8FEEA0(&v33, v17, v18, (int)&v32);
    v9 = *(_DWORD *)a2;
    LODWORD(v22) = &v33;
    ...
    v26 = 1;
    LODWORD(v11) = v10(a2, a3, a4, (unsigned __int8)v23, a6, (unsigned __int16)v24, &v33);
    v23 = v11;
    v12 = v33;
    if ( _InterlockedExchangeAdd((volatile signed __int32 *)(v33 - 4), 0xFFFFFFFF) <= 0 )
      sub_6F8FD6A0((void *)(v12 - 12), (int)&v32);
  }
  else
  {
    v14 = *(_DWORD *)a2;
