int __thiscall sub_6F938D50(int this, int a2, int a3)
{
  int v3; // esi@1
  _DWORD *v4; // eax@1
  char *v5; // ebx@3
  ...
  *(_DWORD *)(*(_DWORD *)(v3 + 8) + 8) = &unk_6FBA6090;
  *(_DWORD *)(*(_DWORD *)(v3 + 8) + 12) = 0;
  *(_DWORD *)(*(_DWORD *)(v3 + 8) + 20) = &unk_6FBA6090;
  *(_DWORD *)(*(_DWORD *)(v3 + 8) + 24) = 0;
  *(_DWORD *)(*(_DWORD *)(v3 + 8) + 28) = &unk_6FBA6090;
  *(_DWORD *)(*(_DWORD *)(v3 + 8) + 32) = 0;
  *(_DWORD *)(*(_DWORD *)(v3 + 8) + 36) = &unk_6FBA6090;
