unsigned int __cdecl sub_6F6BEFC0(_WORD *a1, unsigned int *a2, int a3, int a4, int a5, int a6, int a7, int a8, int a9)
{
  ...
  int v13; // ecx@2
  int v14; // esi@3
  signed int v15; // ebp@3
  signed int v16; // ST1C_4@3
