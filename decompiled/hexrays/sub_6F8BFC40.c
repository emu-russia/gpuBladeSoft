int *__thiscall sub_6F8BFC40(void *this, int a2, int a3, int a4)
{
  _DWORD *v4; // eax@1
  ...
  LOBYTE(v6) = 0;
  v12 = 1;
  sub_6F912830(v6, v4, (int)&v19, a3, a4);
  if ( !v21 )
    sub_6F95AFD0("uninitialized __any_string");
  v12 = 1;
  sub_6F8FEEA0(v10, v19, v20, (int)&v18);
  if ( v21 )
  {
    v12 = 0;
    v21(&v19);
