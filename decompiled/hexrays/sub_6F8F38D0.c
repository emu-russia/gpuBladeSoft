int __stdcall sub_6F8F38D0(int a1, int a2, int a3, int a4, int a5, _DWORD *a6, int a7)
{
  int v7; // eax@1
  __int64 v8; // kr00_8@1
  int v9; // ebp@1
  ...
  v8 = sub_6F8F46F0(__PAIR__(a2, a1), a3, a4, a5, a6, a7, (const wchar_t *)*(_DWORD *)(*(_DWORD *)(v7 + 8) + 8));
  v9 = v8;
  v10 = WORD2(v8) == -1;
  v17 = v10 & ((_DWORD)v8 != 0);
  if ( v17 )
