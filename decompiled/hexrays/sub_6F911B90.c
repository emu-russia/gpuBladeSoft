int __cdecl sub_6F911B90(int a1, _DWORD *a2, int a3, int a4, int a5, int a6, int a7, int a8)
{
  int v8; // eax@1
  ...
  LOBYTE(v14) = 0;
  v18 = -1;
  sub_6F93A600((int)&v24, (_BYTE *)a7, (_BYTE *)(a8 + a7), v14);
  v8 = *a2;
  v16 = (int *)&v24;
  v15 = a6;
  v14 = a5;
  ...
  *(_DWORD *)a3 = a3 + 8;
  LOBYTE(v14) = 0;
  v18 = 2;
  sub_6F93A6C0(a3, v26, &v26[v27], v14);
  *(_DWORD *)(a3 + 24) = sub_6F911930;
  if ( v26 != &v28 )
    j_free_1(v26);
  if ( v24 != &v25 )
    j_free_1(v24);
