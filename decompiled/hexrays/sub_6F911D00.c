int __cdecl sub_6F911D00(int a1, _DWORD *a2, int a3, int a4, int a5, int a6, const void *a7, int a8)
{
  int v8; // eax@1
  ...
  v21 = -1;
  sub_6F8FEEA0(&v29, a7, a8, (int)&v27);
  v8 = *a2;
  v19 = &v29;
  v18 = a6;
  v17 = a5;
