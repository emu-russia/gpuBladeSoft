unsigned int __fastcall sub_6F8ED390(unsigned int a1, int a2, unsigned int a3, unsigned int a4, int a5, int a6, int a7, _DWORD *a8, int a9)
{
  __int64 v9; // rax@1
  ...
  v42 = sub_6F937FA0();
  v25 = &v42;
  sub_6F959A20((int)v41, (double *)a9, a8);
  ...
  if ( (_BYTE)v31 == v11 )
    *a8 |= 2u;
  v12 = v41;
  if ( _InterlockedExchangeAdd(v41 - 1, 0xFFFFFFFF) <= 0 )
    sub_6F9086D0(v12 - 3, (int)&v42);
