unsigned int __cdecl sub_6F6CAC60(_WORD *a1, int *a2, int a3, int a4, unsigned __int8 a5, unsigned __int8 a6, unsigned __int8 a7, int a8, int a9)
{
  ...
  signed int v14; // ebp@3
  signed int v15; // ST18_4@3
  int *v16; // ebx@3
  ...
  if ( (result >> 24) & 0x40 )
  {
    ...
    if ( (unsigned int)(unsigned __int8)v10 >> 7 )
    {
      ...
      *a1 = (4 * ((v18 >> 31) & v18) + 1020) & 0x3E0 | (((WORD2(v19) & (unsigned __int16)(SHIDWORD(v19) >> 31)) + 255) << 7) & 0x7C00 | ((((v17 >> 31) & v17) + 255) >> 3) & 0x1F | 0x8000;
      v20 = *a2;
      HIDWORD(v19) = ((*a2 >> 1) & 0x7F) + (v13 >> 1) - 255;
      v21 = ((signed int)BYTE1(v20) >> 1) + (v14 >> 1) - 255;
      result = v21 >> 31;
      *a2 = (v26 << 24) | (((SHIDWORD(v19) >> 31) & HIDWORD(v19)) + 255) | (((((((unsigned int)*a2 >> 17) & 0x7F)
                                                                             + (v15 >> 1)
