unsigned int __cdecl sub_6F6A92D0(_WORD *a1, int *a2, int a3, int a4, unsigned __int8 a5, unsigned __int8 a6, unsigned __int8 a7, int a8, int a9)
{
  ...
  signed int v23; // esi@4
  int v24; // esi@6
  int v25; // ecx@6
  int v26; // edx@6
  int v27; // [sp+18h] [bp-34h]@3
  int v28; // [sp+1Ch] [bp-30h]@3
  int v29; // [sp+20h] [bp-2Ch]@3
  int v30; // [sp+24h] [bp-28h]@4
  int v31; // [sp+28h] [bp-24h]@4
    ...
    if ( (result >> 24) & 0x40 )
    {
      ...
      if ( (unsigned int)(unsigned __int8)v10 >> 7 )
      {
        ...
        *a1 = (4 * ((v18 >> 31) & v18) + 1020) & 0x3E0 | ((((unsigned __int16)v19 & (unsigned __int16)(v19 >> 31)) + 255) << 7) & 0x7C00 | (((((v16 - 255) >> 31) & (v16 - 255)) + 255) >> 3) & 0x1F | 0x8000;
        ...
        result = v22 >> 31;
        *a2 = (v28 << 24) | (((v21 >> 31) & v21) + 255) | (((v23 & (v23 >> 31)) + 255) << 16) | ((((v22 >> 31) & v22)
                                                                                                + 255) << 8);
      }
      else
      {
