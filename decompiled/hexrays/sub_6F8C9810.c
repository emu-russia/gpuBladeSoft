int __thiscall sub_6F8C9810(void *this, int a2, int a3, int a4, int a5)
{
  size_t v5; // eax@2
  size_t v6; // eax@2
  int v7; // eax@2
  ...
  const wchar_t *v14; // [sp+20h] [bp-78h]@1
  const wchar_t *v15; // [sp+24h] [bp-74h]@1
  const wchar_t *v16; // [sp+28h] [bp-70h]@1
  ...
  LOBYTE(v10[0]) = 0;
  v18 = -1;
  sub_6F93D440((void **)&v24, (const void *)a2, a3, v10[0]);
  v27 = &v29;
  LOBYTE(v10[0]) = 0;
  v18 = 1;
  sub_6F93D440((void **)&v27, (const void *)a4, a5, v10[0]);
  v16 = (const wchar_t *)v24;
  v14 = (const wchar_t *)&v24[2 * v25];
  v15 = (const wchar_t *)v27;
  v13 = &v27[2 * v28];
  while ( 1 )
  {
    v12 = sub_6F8C97E0(v16, v15);
    if ( v12 )
      break;
    v5 = wcslen(v16);
    v16 += v5;
