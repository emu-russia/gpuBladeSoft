int __cdecl sub_6F6EFD10(_WORD *a1, _DWORD *a2, int a3, int a4, unsigned __int8 a5, unsigned __int8 a6, unsigned __int8 a7)
{
  int v7; // edx@1
  int v8; // eax@1
  signed int v9; // esi@1
  ...
  result = v11 | v10 | ((((v8 - 255) & ((v8 - 255) >> 31)) + 255) >> 3) & 0x1F;
  *a1 = result;
