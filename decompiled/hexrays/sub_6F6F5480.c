int __cdecl sub_6F6F5480(_WORD *a1, _DWORD *a2, int a3, int a4, unsigned __int8 a5, unsigned __int8 a6, unsigned __int8 a7)
{
  __int64 v7; // rax@1
  int v8; // esi@1
  int *v9; // edi@1
  ...
  WORD2(v7) &= 0x7C00u;
  result = HIDWORD(v7) | v11 | (((v10 & (v10 >> 31)) + 255) >> 3) & 0x1F;
  *a1 = result;
